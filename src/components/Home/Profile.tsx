    ...
    <div className={classes.main}>
      <div className={classes.TopBar}>
        ...
        <div className={classes.avatarFrame}>
          <img className={classes.imgAvatar} src="https://bookvexe.vn/wp-content/uploads/2023/04/suu-tam-25-anh-cute-avatar-dang-yeu-dieu-ban-can-de-len-mood-cho-ngay-moi_1.jpg" />
      ...
      <div className={classes.ProfileFrame}>
        <div className={classes.ProfileAvatarFrame}>
          <img className={classes.Avatar} src="https://bookvexe.vn/wp-content/uploads/2023/04/suu-tam-25-anh-cute-avatar-dang-yeu-dieu-ban-can-de-len-mood-cho-ngay-moi_1.jpg" />
        </div>
        <p className={classes.textAvatar}>Dương Tiến Vũ</p>
        <div >
          <table className={classes.FrameData}>
            <tbody>
              <tr>
                <td className={classes.text2}>Tên người dùng</td>
                <a className={classes.profileName}>Dương Tiến Vũ</a>
                <td className={classes.text2}>Tên đăng nhập</td>
                <a className={classes.profileUsername}>duongtienvu</a>
              </tr>
              <tr>
                <td className={classes.text2}>Số điện thoại</td>
                <a className={classes.profileSDT}>0886517412</a>
                <td className={classes.text2}>Mật khẩu</td>
                <a className={classes.profilePass}>123456</a>
              </tr>
              <tr>
                <td className={classes.text2}>Email</td>
                <a className={classes.profileEmail}>dtvu0601@gmail.com</a>
                <td className={classes.text2}>Vai trò</td>
                <a className={classes.profileRole}>Dev FE</a>
              </tr>
            </tbody>
          </table>
